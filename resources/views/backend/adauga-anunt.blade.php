    ...
    <div class="container NormalPageWhiteCont">
	    ...
	    <div class="row nopadding">
		    ...
		    <div class="col-xs-12 col-md-7">
		        <form class="form-horizontal" method="POST" action="{{ route('adauga-anunt-post') }}" enctype="multipart/form-data">
		            {{ csrf_field() }}
		            <input type="hidden" name="anunt_id" value="new">
		            <div class="col-md-12">
			            <div class="form-group{{ $errors->has('titlu') ? ' has-error' : '' }}">
			            	<div class="col-md-12">
			                    ...
			                    <input id="titlu" type="text" class="form-control" name="titlu" value="{{ old('titlu') }}" required autofocus placeholder="titlu anunt">
			                    @if ($errors->has('titlu'))
			        ...
			        <div class="col-md-6">
			            <div class="form-group{{ $errors->has('categoriepiesa') ? ' has-error' : '' }}">
			                <div class="col-md-12">
			                	...
			                	<select id="categoriepiesa" name="categoriepiesa" class="form-control">
			                		<option value="">Alege categorie de piesa</option>
			                		<? foreach ($categ_c as $categ_r) { ?>
			                			<option value="<?=$categ_r->categorie?>" <?=old('categoriepiesa') == $categ_r->categorie ? 'selected':''?> required autofocus><?=$categ_r->categorie?></option>
			                		<? } ?>
			                	</select>
			                    @if ($errors->has('categoriepiesa'))
			                        <span class="help-block">
			                            <strong>{{ $errors->first('categoriepiesa') }}</strong>
			                        </span>
			                    @endif
			                </div>
			            </div>
		        	...
		        	<div class="col-md-12">
			            <div class="form-group{{ $errors->has('serie_sasiu') ? ' has-error' : '' }}">
			                ...
			                <div class="col-md-6">
			                	...
			                	<input type="text" name="cod_piesa" id="cod_piesa" class="form-control">
			                    @if ($errors->has('cod_piesa'))
			                        <span class="help-block">
			                            <strong>{{ $errors->first('cod_piesa') }}</strong>
			                        </span>
			                    @endif
			                </div>
			            </div>
                    ...
                    <div class="col-xs-12 col-md-6"> 
                        ...
                        <div class="img_uploaded col-xs-4" id="mod_img_src6"></div>
                    </div>
                    <div class="col-xs-12 col-md-6">  
                        <br/>
                        <div class="fileUpload2 col-xs-8 text-center">
                        ...
                        <div class="img_uploaded col-xs-4" id="mod_img_src7"></div>
                    </div>
                    <div class="col-xs-12 col-md-6">  
                        <br/>
                        <div class="fileUpload2 col-xs-8 text-center">
                        ...
                        <div class="img_uploaded col-xs-4" id="mod_img_src8"></div>
                    </div>
                    <div class="col-xs-12 col-md-6"> 
                        <br/> 
                        <div class="fileUpload2 col-xs-8 text-center">
                        ...
                        <div class="img_uploaded col-xs-4" id="mod_img_src9"></div>
                    </div>
                    ...
                    <div class="col-xs-12 text-center">
                    	<br/> 
                    	<br/> 
                    	<input type="submit" value="Adauga anunt" class="btn btn-primary2">
                    	<br/> 
                    	<br/> 
                    	<br/> 
                    </div>
