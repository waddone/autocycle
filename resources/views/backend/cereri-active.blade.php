    ...
    <div class="container NormalPageWhiteCont">
	    ...
	    <div class="row nopadding">
		    ...
		    <div class="col-xs-12 col-md-10">
		      	<table id="datatable_cereri_active" class="display dt-responsive nowrap bulk_action" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                ...
                <script>
                    $(document).ready(function() {
                        var table = $('#datatable_cereri_active').DataTable( {
                            "bLengthChange": true,
                            "bInfo": true,
                            "pageLength": 20,
                            ...
                            "ajax": "<?=url('/')?>/datatables/cereri-active",
                            "columns": [
                                { "data": "image" },
                                { "data": "marca" },
                                { "data": "piesa" },
                        ...
                        $('#datatable_cereri_active tfoot tr').appendTo('#datatable_cereri_active thead');
