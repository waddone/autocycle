    ...
    <div class="container-fluid NormalPageColor">
        <div class="row">
            <div class="col-xs-12 col-md-10 col-md-offset-1 NormalPageH1X">
                <h1><i class="fas fa-cog"></i> Cerere de piesa</h1>
                @if(Session::has('message'))
                <p class="alert alert-info">{{ Session::get('message') }}</p>
                @endif
            </div>
            <div class="col-xs-12 col-md-10 col-md-offset-1">
                Nu ai gasit piesa de care ai nevoie, te putem ajuta!<br/> 
                Trimite-ne o cerere cu piesa pe care o doresti si te vom contact pe mail sau telefonic.
                <br/><br/>
            </div>
        </div>
    </div>
                                ...
                                <select id="marca" name="marca" class="form-control">
                                    ...
                                    <? foreach ($marci_c as $marci_r) { 
                                        ...
                                        if(old('marca') != '') {
                                            ...
                                            if($a1 != '') {
                                                if($a1 == strtolower($marci_r->marca)) {
                                                    $selected = 'selected';
                                                }
                                            }
                                        }     
                    ...
                    <div class="col-md-12">
                        <div class="form-group{{ $errors->has('descriere') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                ...
                                <textarea name="descriere" class="form-control" placeholder="Introdu piesele de care ai nevoie rand pe rand" style="height: 120px;"><?=$a3?></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('nume') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nume" value="" placeholder="Nume si prenume" class="form-control">
                                @if ($errors->has('nume'))
                                    <span class="help-block">
